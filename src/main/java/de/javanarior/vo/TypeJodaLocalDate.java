 ...
 */
public final class TypeJodaLocalDate {
     ...
     */
    @Deprecated
    public static <V extends Value<V, LocalDate>> V create(Class<V> type, LocalDate value) {
     ...
     */
    public static <V extends Value<V, LocalDate>> V value(Class<V> type, LocalDate value) {
        if (value == null) {
            return null;
        }
        Class<V> classObject = TypeGenerator.generate(type, TECHNICAL_TYPE, WRAPPER_CLASS);
     ...
     * @see TypeJodaLocalDate#nullValue(Class)
     */
    public static <V extends Value<V, LocalDate>> V valueNullSafe(Class<V> type, LocalDate value) {
        if (value == null) {
     ...
     */
    public static <V extends Value<V, LocalDate>> V nullValue(Class<V> type) {
