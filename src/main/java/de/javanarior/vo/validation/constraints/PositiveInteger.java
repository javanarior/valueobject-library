...
/**
 * Reports a error if the Integer is negative.
 */
public class PositiveInteger extends AbstractContraint<Integer> {
    ...
    /**
     * Reports a error if the Integer is negative. The {@code customMessage} is
     * provided in the result in case of an error.
     *
     * @param customMessage
     *            - message to use for constraint violations.
     */
    public PositiveInteger(String customerMessage) {
    ...
    public ConstraintCheckResult check(Integer toValidate) {
        ...
        return new ConstraintCheckResult(getMessage(), toValidate);
    }
