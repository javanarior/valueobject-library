 ...
 * .
 */
public class TypeFactoryInteger<T> {
     ...
     */
    public TypeFactoryInteger() {
        // TODO 15.11.2014: Auto-generated constructor stub
    }

    public T create(Class<T> valueType, int value) {
     ...
     * @return
     */
    private Class<T> loadClass(ByteCodeContainer generated) {
        return (Class<T>)ByteCodeClassLoader.getClassLoader().load(generated);
    }

    private T invokeConstructor(Class<?> clazz, Class<?>[] parameterTypes, int value) {
